...
<html lang="en">
    ...
    <body>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <button type="submit" name="update_pharmaceutical" class="ladda-button btn btn-warning" data-style="expand-right">Update</button>
                                            </form>
                                        </div> 
                                    </div>
                                </div> 
        ...
        <script src="../docassets/js/vendor.min.js"></script>
        <script src="../doc/assets/js/app.min.js"></script>
        <script src="../doc/assets/libs/ladda/spin.js"></script>
        <script src="../doc/assets/libs/ladda/ladda.js"></script>
        <script src="../doc/assets/js/pages/loading-btn.init.js"></script>
