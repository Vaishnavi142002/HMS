<?php
	...
	include('../assets/inc/config.php');
		if(isset($_POST['add_patient_presc']))
		{
			...
			$query="INSERT INTO prescription (doc_id,patient_id,pres_pat_name, pres_pat_number, pres_pat_type, pres_pat_addr, pres_pat_age, pres_number, pres_pat_ailment, pres_ins) VALUES(?,?,?,?,?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('iissssssss', $doc_id,$patient_id,$pres_pat_name, $pres_pat_number, $pres_pat_type, $pres_pat_addr, $pres_pat_age, $pres_number, $pres_pat_ailment, $pres_ins);
			$stmt->execute();
			if($stmt)
			{
				$success = " Addded";
                                            ...
                                            <form method="post">
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" required="required" readonly name="pres_pat_name" value="<?php echo $row->patient_name;?>" class="form-control" id="inputEmail4" placeholder="Name">
                                                    </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input required="required" type="text" readonly name="pres_pat_addr" value="<?php echo $row->patient_add;?>" class="form-control"  id="inputPassword4" placeholder="Address">
                                                    </div>
                                                    <div class="form-group col-md-6 ">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input required="required" type="text" readonly name="pres_pat_age" value="<?php echo $row->patient_age;?>" class="form-control"  id="inputPassword4" placeholder="Patient`s Last Name">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                            <label for="inputPassword4" class="col-form-label"> Type</label>
                                                            <input required="required" readonly type="text" name="pres_pat_type" value="<?php echo $row->patient_type;?>" class="form-control"  id="inputPassword4" placeholder="Patient`s Age">
                                                        </div>
                                                    </div>
                                                ...
                                                <button type="submit" name="add_patient_presc" class="ladda-button btn btn-primary" data-style="expand-right">Add Prescription</button>
                                            </form>
                                        </div> 
                                    </div> 
                                </div> 
