...
<?php
	...
	include('../assets/inc/config.php');
		if(isset($_POST['add_pharmaceutical_category']))
		{
			...
			$query="INSERT INTO pharm_c (pharm_cat_name, pharm_cat_vendor, pharm_cat_desc) VALUES (?,?,?)";
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="admin_dashboard.php">Pharmaceuticals</a></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                           ...
                                           <button type="submit" name="add_pharmaceutical_category" class="ladda-button btn btn-success" data-style="expand-right">Add </button>
