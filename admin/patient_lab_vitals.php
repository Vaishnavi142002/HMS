                                        ...
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="add_single_patient_vitals.php?patient_id=<?php echo $row->patient_id;?>&&patient_number=<?php echo $row->patient_number;?>" class="badge badge-success"><i class="mdi mdi-beaker "></i> Add</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
