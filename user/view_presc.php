                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <?php
                                                ...
                                                $ret="SELECT * FROM  prescription where patient_id=$patient_id"; 
                                            ...
                                            ?><tbody>
                                                <tr>
                                                    ...
                                                    <td><a href="view_single_pres.php?pres_number=<?php echo $row->pres_number;?>&&patient_id=<?php echo $row->patient_id;?>" class="badge badge-success"><i class="fas fa-eye"></i> View </a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
