                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                           ...
                                           $ret="SELECT * FROM  user  WHERE patient_discharge !='Discharged' AND  patient_type = 'InPatient' "; 
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="transfer_single_patient.php?patient_id=<?php echo $row->patient_id;?>&&patient_number=<?php echo $row->patient_number;?>&&patient_type=<?php echo $row->patient_type;?>" class="badge badge-primary"><i class="mdi mdi-check-box-outline "></i> Transfer </a>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row->t_patient_type;?></td>
