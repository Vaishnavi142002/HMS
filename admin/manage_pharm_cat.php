<?php
  ...
  if(isset($_GET['delete_pharm_cat']))
  {
        ...
        $adn="delete from pharma_c where pharm_cat_id=?";
                                        ...
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row->pharm_cat_id;?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="update_single_pharm_category.php?pharm_cat_name=<?php echo $row->pharm_cat_name;?>" class="badge badge-primary"><i class="fas fa-clipboard-check "></i> Update</a>
                                                        <a href="manage_pharm_cat.php?delete_pharm_cat=<?php echo $row->pharm_cat_id;?>" class="badge badge-danger"><i class="fas fa-trash-alt "></i> Delete</a>
