...
<?php
	...
	include('../assets/inc/config.php');
		if(isset($_POST['add_pharmaceutical']))
		{
			...
			$query="INSERT INTO pharma (phar_name, phar_bcode, phar_desc, phar_qty, phar_cat, phar_vendor) VALUES (?,?,?,?,?,?)";
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form method="post">
                                           ...
                                           <button type="submit" name="add_pharmaceutical" class="ladda-button btn btn-success" data-style="expand-right">Add </button>
                                        </form>
                                    </div> 
                                </div> 
                            </div>
