                                ...
                                <div class="card-box">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane show active" id="aboutme">
                                             <ul class="list-unstyled timeline-sm">
                                                <?php
                                                    ...
                                                    $ret="SELECT  * FROM prescription WHERE pres_pat_number = '$pres_pat_number'";
                                                    $stmt= $mysqli->prepare($ret) ;
                                                    $stmt->execute() ;
                                                    $res=$stmt->get_result();
                                        ...
                                        <div class="tab-pane" id="settings">
                                            <ul class="list-unstyled timeline-sm">
                                                <?php
                                                    $lab_pat_number =$_GET['patient_number'];
                                                    $ret="SELECT  * FROM lab WHERE lab_pat_number='$lab_pat_number'";
                                                    $stmt= $mysqli->prepare($ret) ;
                                                    $stmt->execute() ;
                                                    $res=$stmt->get_result();
                                                    while($row=$res->fetch_object())
