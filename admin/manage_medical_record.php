                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="upate_single_medical_record.php?mdr_number=<?php echo $row->mdr_number;?>" class="badge badge-primary"><i class="fas fa-eye-dropper "></i> Update</a>
                                                        <a href="manage_medical_record.php?delete_mdr_number=<?php echo $row->mdr_number;?>" class="badge badge-danger"><i class=" fas fa-trash-alt "></i> Delete</a>
