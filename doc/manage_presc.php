                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <?php
                                                $ret="SELECT * FROM prescription where pres_pat_type='InPatient' ORDER BY RAND() "; 
                                            ...
                                            ?><tbody>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row->pres_pat_age;?></td>
                                                    <td><?php echo $row->pres_pat_addr;?></td>
                                                    <td>
                                                        <a href="view_single_pres.php?pres_number=<?php echo $row->pres_number;?>&&pres_id=<?php echo $row->pres_id;?>" class="badge badge-success"><i class="fas fa-eye"></i> View</a>
