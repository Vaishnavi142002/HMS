...
<?php
	...
	include('../assets/inc/config.php');
		if(isset($_POST['add_patient']))
		{
			...
			if($stmt)
			{
				$success = "$patient_number Patient  Added";
			}
			else {
                                    ...
                                    <form method="post">
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" required="required" name="patient_name" class="form-control" id="inputAddress4" placeholder=" Name">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputPassword4" class="col-form-label">Age</label>
                                                    <input required="required" type="text" name="patient_age" class="form-control"  id="inputPassword4" placeholder="Age">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input required="required" type="text" class="form-control" name="patient_add" id="inputAddress" placeholder="Addresss">
                                            </div>

                                               
                                                <div class="form-group col-md-6">
                                                    <label for="inputPassword4" class="col-form-label">Room </label>
                                                    <input required="required" type="text" name="patient_room_no" class="form-control"  id="inputPassword4" placeholder="Room">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required" type="email" name="patient_email" class="form-control" id="inputCity" placeholder="Email">
                                                </div>
                                                <div class="form-group col-md-2" style="display:none">
                                                    ...
                                                    ?>
                                                    <label for="inputZip" class="col-form-label">Number</label>
